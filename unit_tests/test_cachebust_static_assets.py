...
from title_ui.custom_extensions.cachebust_static_assets.main import md5_for_file
from title_ui.custom_extensions.cachebust_static_assets.main import CachebustStaticAssets
...
class TestCachebustStaticAssets(unittest.TestCase):
    ...
    @mock.patch('title_ui.custom_extensions.cachebust_static_assets.main.CachebustStaticAssets.init_app')
    ...
    def test_url_for_adds_cache_query_string(self):
        filename = 'title_ui/assets/dist/test.txt'
        with open(filename, 'w+') as file:
            file.write('Hello')
    ...
    @mock.patch('title_ui.custom_extensions.cachebust_static_assets.main.md5_for_file', wraps=md5_for_file)
    ...
    def test_far_future_expiry_headers_for_css_file(self):
        filename = 'title_ui/assets/dist/test.css'
        with open(filename, 'w+') as file:
            file.write('Hello')
