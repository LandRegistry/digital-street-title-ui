...
from title_ui.custom_extensions.gzip_static_assets.main import gzip_cache
from title_ui.custom_extensions.gzip_static_assets.main import gzip_cache_key
...
class TestGzipStaticAssets(unittest.TestCase):
    ...
    @mock.patch('title_ui.custom_extensions.gzip_static_assets.main.GzipStaticAssets.init_app')
